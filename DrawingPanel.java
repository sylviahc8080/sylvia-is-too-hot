/*
  Modified by Stuart Reges 4/9/15 to include a DebuggingGraphics inner class
  that keeps track of how many times various drawing methods are called.  It
  includes a showCounts method for the DrawingPanel itself that allows a client
  to examine this.  The panel will record basic drawing methods performed by a
  version of the Graphics class obtained by calling getDebugging Graphics:
...
public final class DrawingPanel extends FileFilter
    ...
    */
    ...
    // new fields to support DebuggingGraphics
    ...
    // variation of getGraphics that returns an object that records a count for
    // various drawing methods...see also getCounts
